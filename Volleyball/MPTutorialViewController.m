...
-(void)showCoachMarks {
	...
	NSArray *coachMarks = @[
				...
				@{
					...
					@"caption": NSLocalizedString(@"Send a message anytime by tapping the VBall (Can be used with 3D Touch!)", @"Shown during the app tutorial"),
				...
				@{
					...
					@"caption": NSLocalizedString(@"Select the player Actions YOU want to track (Can be used with 3D Touch!)", @"Shown during the app tutorial")
					},
				@{
